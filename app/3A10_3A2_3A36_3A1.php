...
$html->load_file('1377262917.Rawdata%3A10%3A2%3A36%3A1.html');
        ...
        if ($count_trs < 2) {
            ...
            if (sizeof($tds) == 1) {
                ...
                if (sizeof($tds) == 9) {
                    ...
                    $table_tbody_tr_tds['game'.$game_number]['time'][] = array('date' => strip_tags($date_and_time[0]), 'time' => strip_tags($date_and_time[1]));
                    ...
                    for ($i = 2;$i < (sizeof($tds) - 1);$i++) {
                        ...
                        switch ($i) {
                            ...
                            case 7 : {
                                if ($span_id[0] != '') {
                                    $odds_half_sd_handicap[] = $span_oe_tag[0].$span_id[0];
                                }
                ...
                if ($count_teams == 2) {
                    ...
                    if (sizeof ($odds_half_sd_handicap) != 0) {
                        $table_tbody_tr_tds['game' . $game_number]['odds']['half']['sd'][] = $odds_half_sd_handicap;
                    } else {
                        $table_tbody_tr_tds['game' . $game_number]['odds']['half']['sd'] = null;
                    }
